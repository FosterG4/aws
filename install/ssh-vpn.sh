...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/FosterG4/aws/main/nginx.conf"

Index_port='81'
IPADDR=$(wget -qO- icanhazip.com);
# creating page download Openvpn config file
mkdir -p /home/vps/public_html
wget -O /home/vps/public_html/index.html "https://raw.githubusercontent.com/FosterG4/aws/main/lain2/index.html"
...
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/FosterG4/aws/main/vps.conf"
...
# websocket-python
wget "https://raw.githubusercontent.com/FosterG4/aws/main/websocket-python/websocket.sh"
chmod +x websocket.sh
screen -S websocket ./websocket.sh
#OpenVPN

wget "https://raw.githubusercontent.com/FosterG4/aws/main/install/vpn.sh"
chmod +x vpn.sh
./vpn.sh
...
wget "https://raw.githubusercontent.com/FosterG4/aws/main/bbr.sh" && chmod +x bbr.sh && ./bbr.sh
wget "https://raw.githubusercontent.com/FosterG4/aws/main/set-br.sh" && chmod +x set-br.sh && ./set-br.sh
...
wget -O prince "https://raw.githubusercontent.com/FosterG4/aws/main/prince" && chmod +x prince
